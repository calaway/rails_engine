  ...
  namespace :api, defaults: {format: :json} do
    namespace :v1 do
      namespace :merchants do
        ...
        get '/:id/favorite_customer',
          to: 'favorite_customer#show',
          as: 'favorite_customer'
        get ':id/customers_with_pending_invoices',
          to: 'pending_invoices#index',
          as: 'pending_invoices'
      end
      ...
      namespace :customers do
        ...
        get '/:id/favorite_merchant',
          to: 'favorite_merchant#show',
          as: "favorite_merchant"
      end
